...
def test_langevin_free():
    ...
    record = {
        ...
        "reference": {"n_particles": n_ref, "slope_error": err_ref, "tol": tol},
    ...
    assert err_ref < tol, (
        f"MSD slope error {err_ref:.3e} exceeds tol {tol:.0e} at N={n_ref}"
    )
